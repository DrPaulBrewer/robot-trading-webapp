...
System.registerDynamic("npm:babel-runtime@5.8.38/core-js/object/assign.js", ["npm:core-js@1.2.6/library/fn/object/assign.js"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
System.registerDynamic("npm:json-editor@0.7.27/dist/jsoneditor.js", [], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
System.registerDynamic("npm:json-editor@0.7.27.js", ["npm:json-editor@0.7.27/dist/jsoneditor.js"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  module.exports = $__require('npm:json-editor@0.7.27/dist/jsoneditor.js');
  return module.exports;
});

System.register('main.js', ['npm:babel-runtime@5.8.38/core-js/object/assign.js', 'npm:json-editor@0.7.27.js'], function (_export) {
			var _Object$assign, positiveNumberArray, plotly, SMRS, VIZ, saveZip, smallDataVisuals, mediumDataVisuals, largeDataJSON, largeDataVisuals, plotParamsSupplyDemand, app;

			return {
						setters: [function (_npmBabelRuntime5838CoreJsObjectAssignJs) {
									_Object$assign = _npmBabelRuntime5838CoreJsObjectAssignJs['default'];
						}, function (_npmJsonEditor0727Js) {}],
						execute: function () {
									...
									positiveNumberArray = require('positive-number-array');
									...
									SMRS = require('single-market-robot-simulator');
									VIZ = require('single-market-robot-simulator-viz-plotly');
									saveZip = require('single-market-robot-simulator-savezip');
									smallDataVisuals = VIZ.build(require("./small-data-visuals.json!"));
									mediumDataVisuals = VIZ.build(require("./medium-data-visuals.json!"));
									largeDataJSON = require("./medium-data-visuals.json!").filter(function (V) {
												'use strict';
												return V.logs.indexOf("buyorder") === -1 && V.logs.indexOf("sellorder") === -1;
									});
									largeDataVisuals = VIZ.build(largeDataJSON);
									plotParamsSupplyDemand = VIZ.supplyDemand();
									...
									app = (function () {
												...
												function showSimulation(simConfig, slot) {
															var visuals = [];
															if (simConfig.config.periods <= 50) visuals = smallDataVisuals;else if (simConfig.config.periods <= 500) visuals = mediumDataVisuals;else visuals = largeDataVisuals;
												...
												function runSimulation(simConfig, slot) {
															...
															var config = _Object$assign({}, simConfig);
															config.xMarket = _Object$assign({}, simConfig.xMarket);
															...
															var onPeriod = function onPeriod(e, sim) {
															...
															var onDone = function onDone(e, sim) {
